...
export const MobileStickyBar: React.FC<MobileStickyBarProps> = ({ onOpenTriagingModal }) => {
  const whatsappUrl = "https://wa.me/5511937711353?text=Ol%C3%A1%2C%20Dra.%20Caren!%20Vim%20pelo%20site%20e%20gostaria%20de%20agendar%20uma%20avalia%C3%A7%C3%A3o%20domiciliar.";
